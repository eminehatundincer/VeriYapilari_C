...
//BAĞLI LİSTEDE BİRİNCİ ELEMANI SİLEN FONKSİYON
...
//BAĞLI LİSTEDE İTEM İLE VERİLEN ELEMANI SİLEN FONKSİYON
...
//BAĞLI LİSTEDE SONDAKİ ELEMANI SİLEN FONKSİYON
...
//BAĞLI LİSTEYİ TERSTEN YAZDIRMAK İÇİN GEREKLİ FONKSİYON
...
//BAĞLI LİSTEYİ YAZDIRAN FONKSİYON
...
int main() {
	...
	basSil(&yeni1); //HEAD DEĞİŞTİĞİ İÇİN & İŞARETİ GEREKLİDİR.
	printf("Başı sildikten sonra: ");
	printList(yeni1); // 10 15 20

	// 'ortSil(yeni1, 10)' çağrısı HATA verir, çünkü bu fonksiyon başı silemez.
	// Mantıklı olan çağrı '15'i silmektir.
	ortSil(yeni1, 15);
